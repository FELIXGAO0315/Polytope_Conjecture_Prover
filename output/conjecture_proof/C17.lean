-- Complete formalization: C17.tex
-- Theorem: C17
-- Generated: 2026-05-26T06:06:08Z
-- Proved (1): C17_BasicConstraints
-- Partial (4): C17_DehnSommervillePoly, C17_FaceDecomposition, C17_CombineConstraints, C17
-- Sorry count: 2
...
-- === C17_BasicConstraints (proved) === [auto-dep]

-- === C17_DehnSommervillePoly (proved) === [auto-dep]

-- === C17_FaceDecomposition (proved) === [auto-dep]
