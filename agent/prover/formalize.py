...
# This file lives at agent/prover/formalize.py, three levels deep from the
# project root.  The project's conjectures.json sits next to run.py at the
# top, so walk up three parents.
